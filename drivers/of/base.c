...
int compare_revision(const char *revision)
{
	...
	if (!min_rev_str[0]) {
#if defined (CONFIG_MACH_MSM8939_ALTEV2_VZW) || defined (CONFIG_MACH_MSM8916_E7IILTE_SPR_US)  || \
      defined(CONFIG_MACH_MSM8916_YG_SKT_KR) || defined(CONFIG_MACH_MSM8916_C100N_KR) || defined(CONFIG_MACH_MSM8916_C100N_GLOBAL_COM) || defined(CONFIG_MACH_MSM8916_C100_GLOBAL_COM)
		min_rev_no = HW_REV_0;
