...
//<asus-danielchan20150415>>>>>>>>>+
 switch (asus_PRJ_ID) {
        case 0://ASUS_ZE550KL
            printk("[%s] ASUS_ZE550KL platform_data",id->name);
            break;
        case 1://ASUS_ZE600KL
            printk("[%s] ASUS_ZE600KL platform_data",id->name);
            break;
        case 2://ASUS_ZX550KL
            printk("[%s] ASUS_ZX550KL platform_data",id->name);
            break;
        case 3://ASUS_ZD550KL
            printk("[%s] ASUS_ZD550KL platform_data",id->name);
            st->plat_data =  ZD550KL_ak09911_compass_data ;
            break;
        default:
            printk("[%s] default platform_data",id->name);
            break;
    }
//<ASUS-danielchan20150415><<<<<<<<+
