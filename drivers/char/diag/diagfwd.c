...
//[FEATURE]-Add-BEGIN by TCTNB.XLJ, 2014/04/12 FR-602797
#if (defined CONFIG_TCT_8X16_ALTO5_VDF || defined CONFIG_TCT_8X16_ALTO5_PREMIUM)
#include "mmc_protect.h"
#endif
