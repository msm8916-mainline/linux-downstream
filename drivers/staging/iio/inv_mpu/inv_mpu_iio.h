...
#define BIT_ANYRD_2CLEAR	0x10
/*  0: 50microSec pulse interrupt,
	1 : int pin held until interrupt status cleared */
...
#define MPU_MEM_BANK_SIZE        255//256 
...
#define LGE_LIGER_SELF_TEST_FLAG
