...
/* This function make less aggressive kswapd(LMK)  */
/* In L-os we do not want this so I revert this function  */
#if defined(CONFIG_HIGHMEM) && !defined(CONFIG_P1BDSN_GLOBAL_COM) && !defined(CONFIG_MACH_MSM8916_C70W_KR)
