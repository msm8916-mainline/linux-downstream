...
#elif defined(CONFIG_MACH_MSM8916_E7IILTE_SPR_US)
static const struct qpnp_vadc_map_pt adcmap_btm_threshold[] = {
	{-300,	1629},
	{-200,	1508},
	{-150,	1455},
...
#elif defined(CONFIG_MACH_MSM8916_PH1_VZW) || \
      defined(CONFIG_MACH_MSM8916_PH1_SPR_US) ||\
      defined(CONFIG_MACH_MSM8916_PH1_CRK_US) ||\
	  defined(CONFIG_MACH_MSM8916_PH1_GLOBAL_COM) || \
	  defined(CONFIG_MACH_MSM8916_PH1_KR)
static const struct qpnp_vadc_map_pt adcmap_btm_threshold[] = {
	{-400,	1700},
	{-350,	1664},
	{-300,	1618},
...
#elif defined(CONFIG_MACH_MSM8916_C90_GLOBAL_COM)
static const struct qpnp_vadc_map_pt adcmap_btm_threshold[] = {
   {-400,  1707},
   {-350,  1672},
   {-300,  1628},
   ...
   {800,   400},
      ...
      defined(CONFIG_MACH_MSM8916_M209_TRF_US) || \
      defined(CONFIG_MACH_MSM8916_M209_TRF_US_VZW)
static const struct qpnp_vadc_map_pt adcmap_btm_threshold[] = {
	{-200,	1521},
	{-190,	1508},
	{-180,	1496},
