...
#ifdef CONFIG_MSM8909_CF
/* PCB_INDICATOR_1 GPIO for PM8916 in CF model*/
#define PCB_INDICATOR_1 1009
#endif
...
#elif defined(CONFIG_MSM8909_CF)
static const struct qpnp_vadc_map_pt adcmap_btm_threshold[] = {
	{-300,	1627},
	{-200,	1506},
	{-100,	1345},
...
static const struct qpnp_vadc_map_pt adcmap_btm_threshold_for_pm8916[] = {
	{-300,	1660},
	{-200,	1558},
	{-100,	1416},
	{0,	1244},
...
#ifdef CONFIG_MSM8909_CF
	if ( gpio_get_value(PCB_INDICATOR_1) == true )
		return qpnp_adc_map_temp_voltage(
			adcmap_btm_threshold_for_pm8916,
			ARRAY_SIZE(adcmap_btm_threshold_for_pm8916),
			bat_voltage,
