...
/* [PLATFORM]-Add-BEGIN by TCTNB.FLF, PR-938209, 2015/03/02, fix update fifo error when suspend */
...
static int backup_ocv_soc(struct qpnp_bms_chip *chip, int ocv_uv, int soc)
{
	...
	//started by feichen@tcl.com for PR 892837
	if(need_keep_100 && soc == 99)
	{
		soc = 100;
		printk("need keep 100 \n");
	}
	//end by feichen@tcl.com
