...
#if defined(CONFIG_SEC_A3_PROJECT) || defined(CONFIG_SEC_A5_PROJECT)|| defined(CONFIG_SEC_SERRANOVE_PROJECT) ||\
	defined(CONFIG_SEC_E5_PROJECT) || defined(CONFIG_SEC_E7_PROJECT) || defined(CONFIG_SEC_HESTIA2_PROJECT) 
