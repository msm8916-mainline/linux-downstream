				  ...
				  union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_ONLINE:
		printk("SMMIONLINECHECK || POWER_SUPPLY_PROP_ONLINE get.");
				  ...
				  const union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_ONLINE:
		...
		// ASUS_BSP +++ Add log to check online status property set or not
			printk("SMMIONLINECHECK || POWER_SUPPLY_PROP_ONLINE set.");
		// ASUS_BSP --- Add log to check online status property set or not
		break;
	case POWER_SUPPLY_PROP_VOLTAGE_MAX:
