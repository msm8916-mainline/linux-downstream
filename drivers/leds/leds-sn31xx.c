...
struct sn31xx_led {
    ...
    unsigned int	en_gpio2;/*[BUGFIX]-Add by TCTNB.ZXZ,PR-893177 2015/01/07,add  led ic sn31xx,gpio2 is used for ind_led*/
    #endif
    /*
...
{               
    ...
    if (value == LED_OFF)
      ...
      else
      {
		...
		sn31xx_write_byte(led->client,0x03,0x08); //i max 5ma 
		sn31xx_write_byte(led->client,0x04, 0x0f); 
#else
		sn31xx_write_byte(led->client,0x03,0x08); //[BUGFIX]-Add by TCTNB.XQJ,PR-946836 2015/03/19,modify max current to 5ma
		sn31xx_write_byte(led->client,0x04, 0x0f); //pwm average current,reduce pwm duty
#endif
...
/*[BUGFIX]-Add by TCTNB.ZXZ,PR-893177 2015/01/07,add  led ic sn31xx,gpio2 is used for ind_led*/
    #if defined(CONFIG_TCT_8X16_IDOL3) || defined(CONFIG_TCT_8X16_IDOL347)
   led->en_gpio2 = of_get_named_gpio_flags(dev->of_node,
			"sn31,en-gpio2", 0, NULL);
    #endif
/*[BUGFIX]-End by TCTNB.ZXZ*/
...
/*[BUGFIX]-End by TCTNB.ZXZ*/
    ...
    #if defined(CONFIG_TCT_8X16_IDOL3) || defined(CONFIG_TCT_8X16_IDOL347)
    gpio_direction_output(led->en_gpio2, 1);/*[BUGFIX]-Add by TCTNB.ZXZ,PR-893177 2015/01/07,add  led ic sn31xx,gpio2 is used for ind_led*/
    #endif
