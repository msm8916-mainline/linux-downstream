...
//modify by yanfei for High bit 20150121
...
//add by yanfei for mutex lock
    ...
    unsigned int ps_low;
    unsigned int ps_high_threshold;
    unsigned int ps_low_threshold;
