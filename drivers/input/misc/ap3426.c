...
//modify by yanfei for sensor calibration 20150514
...
//modify for ps-sensor config by yanfei 20150318 begin	
    ...
    i2c_smbus_write_byte_data(client, AP3426_REG_PS_MEAN, 0x02);//ps mean time = 3
    i2c_smbus_write_byte_data(client, AP3426_REG_PS_INTEGR, 0x10);
