...
#define BMG_DELAY_MIN (10)  /*[BUFFIX]-Add by TCTNB.XQJ, PR-963425,2015/3/31,for cts test*/
...
/* [BUFFIX]-Add- by TCTNB.XQJ,PR-798607, 2014/12/11,add interface interface for selftestin given directory*/
...
static int bmg_resume(struct i2c_client *client)
{
	...
	if (client_data->enable)
		err = BMG_CALL_API(set_mode)(BMG_VAL_NAME(MODE_NORMAL));
/* [BUFFIX]-Add-Begin by TCTNB.XQJ,PR-906832, 2015/02/12,ic lack,it need force set suspend work state*/
     else
     {
