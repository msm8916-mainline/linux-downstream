...
static DEVICE_ATTR(ps_threshold, S_IWUSR | S_IWGRP | S_IRUGO,
		apds993x_show_ps_threshold,
		apds993x_store_ps_threshold);
...
static DEVICE_ATTR(ps_hysteresis_threshold, S_IWUSR | S_IWGRP | S_IRUGO,
				   ...
				   const struct i2c_device_id *id)
{
	...
	err = sysfs_create_group(&data->input_dev_ps->dev.kobj, &apds993x_attr_group);
