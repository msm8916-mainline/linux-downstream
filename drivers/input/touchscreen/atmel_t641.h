...
//#define TOUCH_HALL_IC_SUPPORT 0
...
/* More EVENT */
#define CHARGER_2_KNOCKON_SLEEP     7
#define CHARGER_2_KNOCKON_WAKEUP    8
#define NOCHARGER_2_KNOCKON_SLEEP   9
#define NOCHARGER_2_KNOCKON_WAKEUP  10
...
#if 0
#define TOUCH_INFO_MSG(fmt, args...) 	printk(KERN_INFO "[Touch I] " fmt, ##args)
#define TOUCH_DEBUG_MSG(fmt, args...) 	printk(KERN_DEBUG "[Touch D] " fmt, ##args)
...
#define TOUCH_TEST_MSG(fmt, args...) 	printk(KERN_ERR "[Touch] " fmt, ##args)
#endif
