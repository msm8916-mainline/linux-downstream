...
static const char defaultFirmware[] = "synaptics/p1b/PLG449-V1.02-PR1797768-DS5.2.13.0.1014_40052182.img";
...
static const char defaultFirmware[] = "synaptics/yg/PLG431-V1.27_PR1741017_DS5.2.12.1013_4005019B.img";
#else
...
#if defined(ENABLE_SWIPE_MODE)
			if(ts->lpwgSetting.coverState || !get_swipe_mode || !lockscreen_stat) {
