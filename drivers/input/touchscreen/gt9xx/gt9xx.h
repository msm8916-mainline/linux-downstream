...
//modified for  change cfg by zengguang 2014.6.24
...
struct goodix_ts_platform_data {
	...
	const char *module_name[GOODIX_MAX_CFG_GROUP];	//modified for hardware info by zengguang 2014.6.24
};
struct goodix_ts_data {
	...
	struct workqueue_struct *gt9xx_pm_wq;
	struct delayed_work	gt9xx_pm_work;
	int pm_status;
	spinlock_t		lock;
	//yuquan added end for suspend and resume
	u8  sensor_id;
/*modified for GTP_WITH_PEN by zengguang 2014.6.24 start*/
#if GTP_WITH_PEN
    struct input_dev *pen_dev;
#endif
/*modified for GTP_WITH_PEN by zengguang 2014.6.24 end*/
#if GTP_ESD_PROTECT
    spinlock_t esd_lock;
    u8  esd_running;
    s32 clk_tick_cnt;
    ...
    u8 is_950;
#endif
/*add for pin used by touch start .zengguang2014.07.15*/
    struct pinctrl *ts_pinctrl;
    struct pinctrl_state *gpio_state_active;
    struct pinctrl_state *gpio_state_suspend;
/*add for pin used by touch end .zengguang2014.07.15*/
