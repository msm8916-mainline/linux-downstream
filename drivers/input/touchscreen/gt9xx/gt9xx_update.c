 ...
 *Auther:	zengguang
 *Date	:	2014.6.24
 *Purpose:  goodix firmware update version 2.2,modified for update loading power down and firmware error.
 *
 */
...
#define PACK_SIZE                    128						//modified for pack_size 250->128 by zengguang 2014.7.15
...
static u8 gup_check_update_file(struct i2c_client *client, st_fw_head* fw_head, u8* path)
{
    ...
    #if GTP_AUTO_UPDATE_CFG
        GTP_INFO("Update config  firmware array");
...
#define FL_PACK_SIZE                 128				//modified for pack_size 1024->128 by zengguang 2014.7.15
