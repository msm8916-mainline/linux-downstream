...
struct touch_platform_data {
	...
	struct touch_swipe_info		*swipe_info;
	u8 lpwg_mode;
	u8 send_lpwg;
...
struct touch_swipe_info {

	int support_swipe;
	int enable_swipe;
	int distance_threshold;
	int ratio_threshold;
	int ratio_check_period;
	int min_time_threshold;
	int max_time_threshold;
	int interrupt_status;
	int touch_swipe_time;
};
...
enum {
	...
	IC_CTRL_FIRMWARE_VERSION_SHOW,
	IC_CTRL_SAVE_IC_INFO,
	IC_CTRL_LPWG,
	IC_CTRL_ACTIVE_AREA,
	IC_CTRL_WAKEUP_BY_SWIPE,
};
