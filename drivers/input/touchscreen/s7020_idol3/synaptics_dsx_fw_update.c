...
*/
//[PLATFORM] Add-Begin by bin.su 03/18/2015 CR.948453 idol3 5.5 TP 2nd source FW update function.	
#define FW_IMAGE_NAME "Synaptics_fw_update.img"
#define DO_STARTUP_FW_UPDATE
