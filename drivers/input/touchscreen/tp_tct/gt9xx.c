...
//[PLATFORM]-Add-BEGIN by TCTSZ.yaohui.zeng, 2014/04/11, fix TP irq request
#ifdef CONFIG_TCT_8X16_POP8LTE
	ret = request_threaded_irq(ts->client->irq, goodix_ts_irq_handler,
			NULL,
...
//[PLATFORM]-Add-BEGIN by TCTSZ.yaohui.zeng, 2014/04/11, POP8LTE TP don't need power avdd
#ifndef CONFIG_TCT_8X16_POP8LTE
	if (!IS_ERR(ts->avdd)) {
