...
int mstar_fw_upgrade_start(const u8 *data, u32 data_len, bool force)
{
	...
	if (0 == update_flag)
            printk("update_flag=%d, main_sw_id=%d, info_sw_id=%d, fw_version_major=%d, fw_version_minor=%d, update_bin_major=%d,update_bin_minor=%d \n",
	            update_flag, main_sw_id, info_sw_id, fw_version_major, fw_version_minor, update_bin_major,update_bin_minor);
