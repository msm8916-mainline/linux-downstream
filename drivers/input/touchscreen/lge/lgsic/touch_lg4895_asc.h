...
#ifndef LGE_TOUCH_LG4895_ASC_H
#define LGE_TOUCH_LG4895_ASC_H
...
#define HIGH_DELTA_THRES_LIMIT	(1000)
#define SENSITIVITY_LOW_LIMIT	(100)
#define SENSITIVITY_HIGH_LIMIT	(1000)
#define TEMP_SENSITIVITY	(500)
