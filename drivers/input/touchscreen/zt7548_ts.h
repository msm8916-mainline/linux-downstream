...
#define	SEC_DND_FREQUENCY		180

#define	SEC_HFDND_N_COUNT		15
#define	SEC_HFDND_U_COUNT		18
#define	SEC_HFDND_FREQUENCY		120
...
/* Register Map*/
#define ZT7548_SWRESET_CMD				0x0000
#define ZT7548_WAKEUP_CMD				0x0001
#define ZT7548_IDLE_CMD					0x0004
#define ZT7548_SLEEP_CMD				0x0005
#define ZT7548_CLEAR_INT_STATUS_CMD			0x0003
#define ZT7548_CALIBRATE_CMD				0x0006
#define ZT7548_SAVE_STATUS_CMD				0x0007
#define ZT7548_SAVE_CALIBRATION_CMD			0x0008
#define ZT7548_RECALL_FACTORY_CMD			0x000f
#define ZT7548_THRESHOLD				0x0020
#define ZT7548_DEBUG_REG				0x0115 /* 0~7 */
#define ZT7548_TOUCH_MODE				0x0010
#define ZT7548_CHIP_REVISION				0x0011
#define ZT7548_FIRMWARE_VERSION				0x0012
#define ZT7548_MINOR_FW_VERSION				0x0121
#define ZT7548_VENDOR_ID				0x001C
#define ZT7548_HW_ID					0x0014
#define ZT7548_DATA_VERSION_REG				0x0013
#define ZT7548_SUPPORTED_FINGER_NUM			0x0015
#define ZT7548_EEPROM_INFO				0x0018
#define ZT7548_INITIAL_TOUCH_MODE			0x0019
#define ZT7548_TOTAL_NUMBER_OF_X			0x0060
#define ZT7548_TOTAL_NUMBER_OF_Y			0x0061
#define ZT7548_DELAY_RAW_FOR_HOST			0x007f
#define ZT7548_BUTTON_SUPPORTED_NUM			0x00B0
#define ZT7548_BUTTON_SENSITIVITY			0x00B2
#define ZT7548_DUMMY_BUTTON_SENSITIVITY			0X00C8
#define ZT7548_X_RESOLUTION				0x00C0
...
#define ZT7548_DND_V_FORCE				0x02F1
#define ZT7548_DND_AMP_V_SEL				0x02F9
#define ZT7548_DND_CP_CTRL_L				0x02bd
#define ZT7548_RAWDATA_REG				0x0200
#define ZT7548_EEPROM_INFO_REG				0x0018
#define ZT7548_INT_ENABLE_FLAG				0x00f0
#define ZT7548_PERIODICAL_INTERRUPT_INTERVAL		0x00f1
#define ZT7548_BTN_WIDTH				0x0316
#define ZT7548_CHECKSUM_RESULT				0x012c
#define ZT7548_INIT_FLASH				0x01d0
#define ZT7548_WRITE_FLASH				0x01d1
...
static struct zt7548_ts_info *misc_info;
#if ESD_TIMER_INTERVAL
...
#ifdef CONFIG_HAS_EARLYSUSPEND
static void zt7548_ts_early_suspend(struct early_suspend *h);
static void zt7548_ts_late_resume(struct early_suspend *h);
#endif
