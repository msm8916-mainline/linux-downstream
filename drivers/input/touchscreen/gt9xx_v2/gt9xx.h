...
#define GTP_POWER_CTRL_SLEEP  1	//[DEBUG] Modify TCT-NB Tianhongwei 05/05/2014 power off ic when sleepin if the gesture is disabled
#define GTP_ICS_SLOT_REPORT   0  //TCT-NB.Tianhongwei modify for RR.708639

//[DEBUG]-modify by TCTNB.TianHongwei 2014/5/19 open the fw upate fuction.
...
/*[FEATURE]-remove by TCTNB.TianHongwei 05/28/2014 debug info onoff switch*/
...
struct goodix_ts_data {
   ...
   u32 irq_gpio_flags;
    ...
    u8  fixed_cfg;
    u8  fw_error;
	bool power_on;//[DEBUG] Modify TCT-NB Tianhongwei 05/05/2014 power off ic when sleepin if the gesture is disabled
	...
	u8 gesture_onoff;
	u8 gesture_code;
	u8 gesture_piont_num;
	struct tp_point gesture_point[64];
#endif
	u8 glove_mode;
	u8 sensor_id;
	spinlock_t glove_lock;
};
...
//zxzadd
extern int gt_reset_gpio;
extern int gt_irq_gpio;

#define GTP_RST_PORT    12
#define GTP_INT_PORT    13
#define GTP_INT_IRQ     gpio_to_irq(gt_irq_gpio)
