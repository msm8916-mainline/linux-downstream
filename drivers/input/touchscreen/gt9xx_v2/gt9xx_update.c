...
/*[FEATURE]-Add by TCTNB.TianHongwei 05/28/2014 debug info onff switch*/
extern u8 GTP_DEBUG_ON;
extern u8  GTP_DEBUG_ARRAY_ON;
extern u8  GTP_DEBUG_FUNC_ON;
/*[FEATURE]-end by TCTNB.TianHongwei */
...
extern s32 gtp_read_version(struct goodix_ts_data *ts);//[FEATURE]-Modify by TCTNB.TianHongwei 2014/5/19 show fw version for app.
...
extern int gtp_get_cfg_dtsi(struct goodix_ts_data *ts,u8 * data,u8 mode);
...
static s32 gup_init_panel(struct goodix_ts_data *ts)
{
    ...
    gtp_read_version(ts);//[FEATURE]-Modify by TCTNB.TianHongwei 2014/5/19 show fw version for app.
    msleep(10);
    return 0;
}
...
s32 gup_enter_update_mode(struct i2c_client *client)
{
    ...
    GTP_GPIO_OUTPUT(gt_reset_gpio, 0);
    msleep(2);
...
//[FEATURE]-Add by TCTNB.TianHongwei 2014/5/19 show fw version for app.
...
//[FEATURE]-Add by TCTNB.TianHongwei
