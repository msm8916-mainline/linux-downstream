...
extern ssize_t DrvMainFirmwareTestLogShow(struct device *pDevice, struct device_attribute *pAttr, char *pBuf);
extern ssize_t DrvMainFirmwareTestLogStore(struct device *pDevice, struct device_attribute *pAttr, const char *pBuf, size_t nSize);
extern ssize_t DrvMainFirmwareTestFailChannelShow(struct device *pDevice, struct device_attribute *pAttr, char *pBuf);
extern ssize_t DrvMainFirmwareTestFailChannelStore(struct device *pDevice, struct device_attribute *pAttr, const char *pBuf, size_t nSize);
extern ssize_t DrvMainFirmwareTestScopeShow(struct device *pDevice, struct device_attribute *pAttr, char *pBuf);
extern ssize_t DrvMainFirmwareTestScopeStore(struct device *pDevice, struct device_attribute *pAttr, const char *pBuf, size_t nSize);
...
extern void DrvMainFirmwareProximityEnable(int);
extern u16 DrvMainFirmwareProximityStatus(void);
