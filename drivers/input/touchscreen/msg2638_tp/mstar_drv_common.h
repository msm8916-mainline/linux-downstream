...
/*
 * Note.
 * The below compile option is used to enable proximity function for firmware.
 * By default, this compile option is disabled.
 */
#define CONFIG_TOUCHSCREEN_PROXIMITY_SENSOR
 ...
 * By default, this compile option is disabled.
 */
 /* [PLATFORM]-Mod- by TCTNB.ZXZ, PR-814306, 2014/10/24, add for rawdata test */
...
/*
 * Note.
*It use for debug for delta cap.
*/
//#define TP_PRINT
...
//////**************************////
//show the status of charger
#define CONFIG_ENABLE_CHARGER_STATUS



#ifdef TP_DEBUG_ON
 extern int tp_debug_on;
#endif
extern u8 _gIsUpdateFirmware ;
...
#endif
*/
#define DBG(fmt, arg...) do{if(tp_dbg)printk(fmt, ##arg);}while(0)	//furong
