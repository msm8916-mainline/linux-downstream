...
static inline int cyttsp5_request_enable_scan_type(struct cyttsp5_device *ttsp,
		u8 scan_type)
{
	struct cyttsp5_core *cd = ttsp->core;
	struct cyttsp5_core_driver *d = to_cyttsp5_core_driver(cd->dev.driver);
...
static inline int cyttsp5_request_disable_scan_type(struct cyttsp5_device *ttsp,
		u8 scan_type)
{
	struct cyttsp5_core *cd = ttsp->core;
	struct cyttsp5_core_driver *d = to_cyttsp5_core_driver(cd->dev.driver);
