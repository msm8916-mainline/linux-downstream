...
int fts_ctpm_fw_upgrade(struct i2c_client *client, u8 *pbt_buf,
			  u32 dw_lenth);
//modify by junfeng.zhou for update firmware begin . 20140804
/*tianhongwei 2014/11/03 update new firmwarw version = 0x14*/
#if defined(CONFIG_TCT_8X16_ALTO4)
static unsigned char CTPM_FW[] = {
//	#include "firmware/mutto4GL/Alto4_MD53_V10_6336_20140724_app.h"
	#include "firmware/mutto4GL/ALTO4GL_MD53_V14_6336_20141031_app.h"
};
#elif defined(CONFIG_TCT_8X16_ALTO4NA)
static unsigned char CTPM_FW[] = {
	#include "firmware/junda4NA/ALTO4_JD85_V10_6336_20140819_app.h"
};
#elif defined(CONFIG_TCT_8X16_ALTO4EVDO)
static unsigned char CTPM_FW[] = {
	#include "firmware/junda4EVDO/ALTO4_JD85_V10_6336_20140819_app.h"
};
#else
static unsigned char CTPM_FW[] = {
	#include "firmware/junda4EVDO/ALTO4_JD85_V10_6336_20140819_app.h"
...
#endif
/*
#ifdef CONFIG_TCT_8X16_ALTO5TF
static unsigned char CTPM_FW[] = {
	//#include "firmware/mutto4GL/Alto4_MD53_V10_6336_20140724_app.i"
};
#endif

#ifdef CONFIG_TCT_8X16_ALTO5
static unsigned char CTPM_FW[] = {
	//#include "firmware/junda5GL/ALTO4_JD85_V10_6336_20140819_app.i"
};
#endif
*/
//modify by junfeng.zhou for update firmware end .
...
/*tianhongwei 2014/11/03 update new firmwarw version = 0x14*/
#if defined(CONFIG_TCT_8X16_ALTO4)
    unsigned char version_list[] = {0x10,};
#elif defined(CONFIG_TCT_8X16_ALTO4NA)
    unsigned char version_list[] = {};  
#elif defined(CONFIG_TCT_8X16_ALTO4EVDO)
    unsigned char version_list[] = {};  
#else
    unsigned char version_list[] = {};  
    ...
    printk(KERN_INFO "%s uc_tp_fm_ver = 0x%x uc_host_fm_ver = 0x%x ",__func__,uc_tp_fm_ver,uc_host_fm_ver);
        ...
        if(i == sizeof(version_list)/sizeof(version_list[0]))
            printk(KERN_INFO " it not nedd to upgrade to new version!");
	return 0;
}
					...
					char *buf)
{
	...
	num_read_chars = snprintf(buf, PAGE_SIZE, "%s_%s_V0x%02X\n",IC_vendor,module_vendor,fwver);
...
static ssize_t ft6x06_debug_write(struct file *filp, const char __user *userbuf,
...
static ssize_t ft6x06_debug_read(struct file *file, char __user *user_buf,
         size_t count, loff_t *ppos)
{
	struct i2c_client *client/* = (struct i2c_client *)(ft6x06_proc_entry->data)*/;
	//struct i2c_client *client = PDE_DATA(ft6x06_proc_entry);
