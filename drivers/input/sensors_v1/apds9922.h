...
#define APDS9922_DD_CLEAR_DATA_ADDR 0x0A
#define APDS9922_DD_CLEAR_DATA_0_ADDR 0x0A
#define APDS9922_DD_CLEAR_DATA_1_ADDR 0x0B
#define APDS9922_DD_CLEAR_DATA_2_ADDR 0x0C
...
#define APDS9922_DD_COMP_DATA_ADDR 0x16
#define APDS9922_DD_COMP_DATA_0_ADDR 0x16
#define APDS9922_DD_COMP_DATA_1_ADDR 0x17
#define APDS9922_DD_COMP_DATA_2_ADDR 0x18
...
#define APDS9922_DD_PRX_CAN_ADDR 0x1F
#define APDS9922_DD_PRX_CAN_0_ADDR 0x1F
#define APDS9922_DD_PRX_CAN_1_ADDR 0x20
...
#define	APDS9922_DD_ALS_THRES_VAR_ADDR 0x27
#define	APDS9922_DD_DEVICE_CONFIG_ADDR 0x2F
...
#define APDS9922_DD_LED_CURRENT_PEAK_ON 0x08
...
#define APDS9922_DD_ALS_MEAS_RES_20_BIT 0x00 /* ALS resolution 20 bit (full range : 0 ~ 1048575) [ADC conversion time = 400ms] */
#define APDS9922_DD_ALS_MEAS_RES_19_BIT 0x10 /* ALS resolution 19 bit (full range : 0 ~ 524287) [ADC conversion time = 200ms]  */
#define APDS9922_DD_ALS_MEAS_RES_18_BIT 0x20 /* ALS resolution 18 bit (full range : 0 ~ 262143) [ADC conversion time = 100ms]  */
#define APDS9922_DD_ALS_MEAS_RES_17_BIT 0x30 /* ALS resolution 17 bit (full range : 0 ~ 131071) [ADC conversion time = 50ms]  */
#define APDS9922_DD_ALS_MEAS_RES_16_BIT 0x40 /* ALS resolution 16 bit (full range : 0 ~ 65535) [ADC conversion time = 25ms]  */
...
#define APDS9922_DD_PRX_LOGIC_MODE 0x02 /* 1: PS Logic Output Mode: INT pad is updated after every measurement and maintains output state between measurements */
...
#define APDS9922_DD_ALS_VAR_8_COUNT 0x00 /* ALS result varies by 8 counts compared to previous result */
#define APDS9922_DD_ALS_VAR_16_COUNT 0x01 /* ALS result varies by 16 counts compared to previous result */
#define APDS9922_DD_ALS_VAR_32_COUNT 0x02 /* ALS result varies by 32 counts compared to previous result */
#define APDS9922_DD_ALS_VAR_64_COUNT 0x03 /* ALS result varies by 64 counts compared to previous result */
#define APDS9922_DD_ALS_VAR_128_COUNT 0x04 /* ALS result varies by 128 counts compared to previous result */
#define APDS9922_DD_ALS_VAR_256_COUNT 0x05 /* ALS result varies by 256 counts compared to previous result */
#define APDS9922_DD_ALS_VAR_512_COUNT 0x06 /* ALS result varies by 512 counts compared to previous result */
#define APDS9922_DD_ALS_VAR_1024_COUNT 0x07 /* ALS result varies by 1024 counts compared to previous result */

#define APDS9922_SUCCESS 0
#define APDS9922_ERR_I2C -1
#define APDS9922_ERR_STATUS -3
#define APDS9922_ERR_SETUP_FAILURE -4
#define APDS9922_ERR_GETGSENSORDATA -5
#define APDS9922_ERR_IDENTIFICATION -6

#define APDS9922_DD_LUX_FACTOR    413//314 // for glass transmittance of 10%, use 30 for open air	
...
#define APDS9922_PS_DETECTION_THRESHOLD 200
#define APDS9922_PS_HSYTERESIS_THRESHOLD 150

#define	APDS9922_DD_PRX_DEFAULT_PULSE 16	// drop to 16 if crosstalk is too high
#define APDS9922_DD_PRX_DEFAULT_LED_CURRENT APDS9922_DD_LED_CURRENT_100_MA
#define APDS9922_DD_PRX_DEFAULT_LED_FREQ APDS9922_DD_LED_FREQ_60_KHZ
#define APDS9922_DD_PRX_DEFAULT_RES APDS9921_DD_PRX_MEAS_RES_10_BIT
