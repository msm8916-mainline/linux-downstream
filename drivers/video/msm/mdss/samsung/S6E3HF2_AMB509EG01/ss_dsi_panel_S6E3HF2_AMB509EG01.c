 ...
 *
*/
#include "ss_dsi_panel_S6E3HF2_AMB509EG01.h"
#include "ss_dsi_mdnie_S6E3HF2_AMB509EG01.h"
...
static int mdss_panel_revision(struct mdss_dsi_ctrl_pdata *ctrl)
{
	...
	if (mdss_panel_id2_get(ctrl) == 0x10)
		vdd->panel_revision = 'A' - 'A';
	else if (mdss_panel_id2_get(ctrl) == 0x11)
		vdd->panel_revision = 'A' - 'A';
	else
		vdd->panel_revision = 'A' - 'A';
...
static void  mdss_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E3HF2_AMB509EG01;
...
static int __init samsung_panel_init(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6E3HF2_AMB509EG01_WQHD";
