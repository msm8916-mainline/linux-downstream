 ...
 *
*/
#include "ss_dsi2lvds_VX5B3D_LTM215HT05.h"
...
static void mdss_brightness_tft_pwm_lvds(struct mdss_dsi_ctrl_pdata *ctrl, int level)
{
	...
	if (vx5b3d_level != 0) {
		...
		pr_info("[MIPI2LVDS-21INCH]:level=%d vx5b3d_level:%d auto_brightness:%d CABC:%d \n",\
...
static void mdss_lvds_data_ql(struct mdss_dsi_ctrl_pdata *ctrl)
{
	...
	vdd->panel_func.samsung_lvds_write_reg(0x704, 0x101EA);
	...
	vdd->panel_func.samsung_lvds_write_reg(0x124, 0x9E1C780);
	vdd->panel_func.samsung_lvds_write_reg(0x128, 0x10280B);
	vdd->panel_func.samsung_lvds_write_reg(0x12C, 0x31);
	...
	vdd->panel_func.samsung_lvds_write_reg(0x22C, 0xFF09);
	...
	vdd->panel_func.samsung_lvds_write_reg(0x258, 0xA0027);
...
static void mdss_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->support_panel_max = VX5B3D_LTM215HT05_SUPPORT_PANEL_COUNT;
...
static int __init samsung_panel_init(void)
{
	...
	char panel_string[] = "ss_dsi_panel_VX5B3D_LTM215HT05_FHD";
