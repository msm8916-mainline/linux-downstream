 ...
 *
*/
#include "ss_dsi_panel_S6D7AA0_LSL080AL03_BOE.h"
#include "ss_dsi_mdnie_S6D7AA0_LSL080AL03_BOE.h"
...
static struct dsi_panel_cmds * mdss_brightness_tft_pwm(struct mdss_dsi_ctrl_pdata *ctrl, int *level_key)
{
	...
	if(vdd->bl_level >= 255 && vdd->auto_brightness)
		mdss_samsung_cabc_update_tft(ctrl, 1);
	else if(vdd->auto_brightness)
		mdss_samsung_cabc_update_tft(ctrl, 0);
...
static int __init samsung_panel_init(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6D7AA0_LSL080AL03_BOE_WXGA";
