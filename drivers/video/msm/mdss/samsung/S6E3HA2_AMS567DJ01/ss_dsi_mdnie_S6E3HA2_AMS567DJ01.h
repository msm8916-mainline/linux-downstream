 ...
 *
*/
#ifndef _SS_DSI_MDNIE_S6E3HA2_AMS567DJ01_H_
#define _SS_DSI_MDNIE_S6E3HA2_AMS567DJ01_H_
...
/*
static struct dsi_cmd_desc HMT_GRAY_1_MDNIE[] = {
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(level_1_key_on)}, level_1_key_on},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_GRAY_1_1)}, HMT_GRAY_1_1},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_GRAY_1_2)}, HMT_GRAY_1_2},
	{{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(level_1_key_off)}, level_1_key_off},
};

static struct dsi_cmd_desc HMT_GRAY_2_MDNIE[] = {
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(level_1_key_on)}, level_1_key_on},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_GRAY_2_1)}, HMT_GRAY_2_1},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_GRAY_2_2)}, HMT_GRAY_2_2},
	{{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(level_1_key_off)}, level_1_key_off},
};
static struct dsi_cmd_desc HMT_GRAY_3_MDNIE[] = {
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(level_1_key_on)}, level_1_key_on},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_GRAY_3_1)}, HMT_GRAY_3_1},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_GRAY_3_2)}, HMT_GRAY_3_2},
	{{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(level_1_key_off)}, level_1_key_off},
};
static struct dsi_cmd_desc HMT_GRAY_4_MDNIE[] = {
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(level_1_key_on)}, level_1_key_on},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_GRAY_4_1)}, HMT_GRAY_4_1},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_GRAY_4_2)}, HMT_GRAY_4_2},
	{{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(level_1_key_off)}, level_1_key_off},
};
static struct dsi_cmd_desc HMT_GRAY_5_MDNIE[] = {
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(level_1_key_on)}, level_1_key_on},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_GRAY_5_1)}, HMT_GRAY_5_1},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_GRAY_5_2)}, HMT_GRAY_5_2},
	{{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(level_1_key_off)}, level_1_key_off},
};

static struct dsi_cmd_desc *hmt_gray_tune_value_dsi0[HMT_GRAY_MAX] = {
	NULL,
	HMT_GRAY_1_MDNIE,
	HMT_GRAY_2_MDNIE,
	HMT_GRAY_3_MDNIE,
...
*/
static struct dsi_cmd_desc HMT_COLOR_TEMPERATURE_3000_MDNIE[] = {
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(level_1_key_on)}, level_1_key_on},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_COLOR_TEMPERATURE_3000_1)}, HMT_COLOR_TEMPERATURE_3000_1},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_COLOR_TEMPERATURE_3000_2)}, HMT_COLOR_TEMPERATURE_3000_2},
	{{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(level_1_key_off)}, level_1_key_off},
};

static struct dsi_cmd_desc HMT_COLOR_TEMPERATURE_4000_MDNIE[] = {
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(level_1_key_on)}, level_1_key_on},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_COLOR_TEMPERATURE_4000_1)}, HMT_COLOR_TEMPERATURE_4000_1},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_COLOR_TEMPERATURE_4000_2)}, HMT_COLOR_TEMPERATURE_4000_2},
	{{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(level_1_key_off)}, level_1_key_off},
};
static struct dsi_cmd_desc HMT_COLOR_TEMPERATURE_5000_MDNIE[] = {
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(level_1_key_on)}, level_1_key_on},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_COLOR_TEMPERATURE_5000_1)}, HMT_COLOR_TEMPERATURE_5000_1},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_COLOR_TEMPERATURE_5000_2)}, HMT_COLOR_TEMPERATURE_5000_2},
	{{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(level_1_key_off)}, level_1_key_off},
};
static struct dsi_cmd_desc HMT_COLOR_TEMPERATURE_6500_MDNIE[] = {
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(level_1_key_on)}, level_1_key_on},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_COLOR_TEMPERATURE_6500_1)}, HMT_COLOR_TEMPERATURE_6500_1},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_COLOR_TEMPERATURE_6500_2)}, HMT_COLOR_TEMPERATURE_6500_2},
	{{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(level_1_key_off)}, level_1_key_off},
};
static struct dsi_cmd_desc HMT_COLOR_TEMPERATURE_7500_MDNIE[] = {
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(level_1_key_on)}, level_1_key_on},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_COLOR_TEMPERATURE_7500_1)}, HMT_COLOR_TEMPERATURE_7500_1},
	{{DTYPE_DCS_LWRITE, 0, 0, 0, 0, sizeof(HMT_COLOR_TEMPERATURE_7500_2)}, HMT_COLOR_TEMPERATURE_7500_2},
	{{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(level_1_key_off)}, level_1_key_off},
};
...
static struct dsi_cmd_desc *hmt_color_temperature_tune_value_dsi0[HMT_COLOR_TEMP_MAX] = {
	...
	*/
	NULL,
	HMT_COLOR_TEMPERATURE_3000_MDNIE,
	HMT_COLOR_TEMPERATURE_4000_MDNIE,
	HMT_COLOR_TEMPERATURE_5000_MDNIE,
	HMT_COLOR_TEMPERATURE_6500_MDNIE,
	HMT_COLOR_TEMPERATURE_7500_MDNIE,
};
