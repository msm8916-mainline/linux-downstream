...
/*add qcom patch for display flash blue screen by wangjiao1 begin*/
/*
...
*/
/*add qcom patch for display flash blue screen by wangjiao1 end*/
...
static int mdp3_dmap_histo_reset(struct mdp3_dma *dma)
{
	...
	init_completion(&dma->histo_comp);
    /*add qcom patch for display flash blue screen by wangjiao1*/
