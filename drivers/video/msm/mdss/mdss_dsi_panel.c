...
/*TCTCD ke.li modify for PR.899149 Start 20150112*/
#if defined CONFIG_TCT_8X16_ALTO5_VDF
	ctrl->pwm_enabled = 0;
#endif
/*TCTCD ke.li modify for PR.899149 End 20150112*/
}
...
static void mdss_dsi_panel_bklt_pwm(struct mdss_dsi_ctrl_pdata *ctrl, int level)
{
	int ret;
	u32 duty;
	#ifndef	CONFIG_TCT_8X16_ALTO5_VDF
	u32 period_ns;
	#endif
	...
	pr_debug("%s: ndx=%d level=%d duty=%d\n", __func__,
					ctrl->ndx, level, duty);
#if defined CONFIG_TCT_8X16_ALTO5_VDF
//ke.li remove code for PR.899149 20150112
#else
	if (ctrl->pwm_enabled) {
		pwm_disable(ctrl->pwm_bl);
		ctrl->pwm_enabled = 0;
