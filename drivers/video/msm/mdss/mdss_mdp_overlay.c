...
#if !defined(CONFIG_LGE_MIPI_DSI_LGD_NT35521_E7II_WXGA) && !defined(CONFIG_LGE_MIPI_DSI_BYD_ILI9806E_WVGA) && !defined(CONFIG_JDI_INCELL_VIDEO_HD_PANEL) && !defined(CONFIG_LGE_DUALITY_JDI_LGD)
	ret = mdss_iommu_ctrl(1);
	if (IS_ERR_VALUE(ret)) {
