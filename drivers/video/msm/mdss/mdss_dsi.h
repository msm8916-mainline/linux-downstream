...
#define ESD_STATUS_VALUE_MAX_LEN 10  //lm for ESD
...
struct mdss_dsi_ctrl_pdata {
	...
	//lm add for ESD
	u32 status_value_array[ESD_STATUS_VALUE_MAX_LEN];
	u32 status_value_len;
	struct dsi_panel_cmds status_cmds1;
	u32 status_cmds_rlen1;
	struct dsi_buf status_buf1;
	u32 status_value_array1[ESD_STATUS_VALUE_MAX_LEN];
	u32 status_value_len1;
};
