...
#define CM36686_PROXIMITY_THDL_DEFAULT  	(10)
#define CM36686_PROXIMITY_THDH_DEFAULT  	(26)
#define CM36686_PROXIMITY_INF_DEFAULT  		(3)
#define CM36686_PROXIMITY_AUTOK_MIN  		(3)
#define CM36686_PROXIMITY_AUTOK_MAX  		(40)
#define CM36686_LIGHT_200LUX_DEFAULT		(534)
#define CM36686_LIGHT_1000LUX_DEFAULT		(2338)
#define CM36686_LIGHT_MAX_THRESHOLD		(65535)
