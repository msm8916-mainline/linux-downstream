...
static int qpnp_lpg_configure_pwm(struct qpnp_pwm_chip *chip)
{
	...
	if (rc)
		return rc;
#if defined(CONFIG_MACH_MSM8916_G4STYLUSDS_GLOBAL_COM) || \
defined(CONFIG_MACH_MSM8939_P1B_GLOBAL_COM) || \
defined(CONFIG_MACH_MSM8939_P1BDSN_GLOBAL_COM) || \
...
defined(CONFIG_MACH_MSM8916_PH1_VZW) || \
defined(CONFIG_MACH_MSM8916_PH1_GLOBAL_COM) || defined(CONFIG_MACH_MSM8916_PH1_KR) || \
defined(CONFIG_MACH_MSM8916_YG_SKT_KR) || defined(CONFIG_MACH_MSM8916_M216N_KR) || defined(CONFIG_MACH_MSM8916_C100N_KR) || defined(CONFIG_MACH_MSM8916_C100N_GLOBAL_COM) || defined(CONFIG_MACH_MSM8916_C100_GLOBAL_COM) || defined(CONFIG_MACH_MSM8916_M216_GLOBAL_COM) || \
	defined(CONFIG_MACH_MSM8939_PH2_GLOBAL_COM) || defined(CONFIG_MACH_MSM8916_PH1_SPR_US) || \
defined(CONFIG_MACH_MSM8916_K5_GLOBAL_COM) || defined(CONFIG_MACH_MSM8916_PH1_CRK_US) || defined(CONFIG_MACH_MSM8916_K5_CMO_CN)
