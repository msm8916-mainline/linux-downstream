...
static int32_t s5k3m2_idol3_otp_i2c_write(struct msm_sensor_ctrl_t * s_ctrl,
...
static uint16_t s5k3m2_idol3_otp_i2c_read(struct msm_sensor_ctrl_t * s_ctrl,
    uint32_t addr)
{
    int rc = 0;
    uint16_t data = 0;
...
static int s5k3m2_idol3_otp_LSC_on(struct msm_sensor_ctrl_t * s_ctrl)
{
    int rc = 0;
...
static int s5k3m2_idol3_otp_stream_on(struct msm_sensor_ctrl_t * s_ctrl)
{
    int rc = 0;
...
void s5k3m2_idol3_otp_AWB_on(struct msm_sensor_ctrl_t * s_ctrl,uint8_t *buffer, uint16_t size)
{
    uint16_t R_test;
    uint16_t B_test;
    uint16_t Gr_test;
...
static int s5k3m2_idol3_read_otp(struct msm_sensor_ctrl_t * s_ctrl,uint8_t page, uint16_t address, uint8_t *buffer, uint16_t size)
{
    uint8_t  reVal = 0;
    uint16_t i = 0;
    int nCheckSum = 0;
...
static int s5k3m2_idol3_update_otp(struct msm_sensor_ctrl_t * s_ctrl)
{	uint8_t buf[64];
	int rc;
	rc = s5k3m2_idol3_read_otp(s_ctrl,31, S5K3M2_IDOL3_OTP_BASE_ADD, buf,64);
	return rc;
