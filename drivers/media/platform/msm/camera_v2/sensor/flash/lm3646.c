...
static struct msm_camera_i2c_reg_array lm3646_init_array[] = {
	{0x04, 0x47}, //time out
	{0x05, 0x7B}, /* MAX: torch: 187.10mA, flash: 1124.60mA */
	{0x06, 0x2F}, /* LED1 flash: 562.16mA */
	{0x07, 0x3F}, /* LED1 torch: 93.05mA */
	{0x01, 0xE0},
};
...
{
//lwl 
	printk("lwl debug msm_led_torch_brightness_set value = %d\n",value);
		...
		const struct i2c_device_id *id)
{
	...
	if (!rc)
		msm_lm3646_torch_create_classdev(&(client->dev),NULL);
	return rc;
}
