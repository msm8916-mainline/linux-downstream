...
unsigned int g_hi545_module_id = 0;
...
static int msm_eeprom_platform_probe(struct platform_device *pdev)
{
	...
	if (!strcmp(eb_info->eeprom_name, "hynix_hi545")) {
		// [TODO] to judge the otp data is valid.
		g_hi545_module_id = e_ctrl->cal_data.mapdata[1];
	}
