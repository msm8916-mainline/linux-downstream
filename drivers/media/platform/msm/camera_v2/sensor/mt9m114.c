...
static struct msm_camera_i2c_reg_conf mt9m114_recommend_settings[] = {
	...
	{0x0990, 0x02D8},    // cam_sensor_cfg_pixclk
	{0x0992, 0xC280},    // cam_sensor_cfg_pixclk
	// 0xC808, 0x2D8C280},    //cam_sensor_cfg_pixclk = 47760000
	{0xC80C, 0x0001},    //cam_sensor_cfg_row_speed = 1
	{0xC80E, 0x00DB},    //cam_sensor_cfg_fine_integ_time_min = 219


	{0xC810, 0x05B1},    //cam_sensor_cfg_fine_integ_time_max = 1457 *****
	{0xC812, 0x03ee},    //cam_sensor_cfg_frame_length_lines = 1006 *****
	{0xC814, 0x0634},    //cam_sensor_cfg_line_length_pck = 1588 ******
	...
	{0xC88C, 0x1DE5},    //cam_aet_max_frame_rate = 7653 *****
	...
	void __user *argp)
{
	...
	case CFG_SET_START_STREAM:
		pr_err("%s:%d CFG_SET_START_STREAM\n", __func__, __LINE__);
#if 0
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
			i2c_write_conf_tbl(
