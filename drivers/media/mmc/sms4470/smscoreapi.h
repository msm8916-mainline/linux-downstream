...
#endif
#ifdef SMS_SDIO_DRV
#define SMS_LARGE_MEM_MALLOC_ONCE
#endif
#define	SMS_MULTI_FW_SUPPORTED

//#define	SMS_FW_MEM_MALLOC_ONCE
...
extern void smscore_flush_dcache(void * dev, unsigned long offset, unsigned int size);
#ifdef SMS_TS_RECORD
...
#define sms_sdio_plug_notify(plugin) sms_sdio_ctrl (SDIO_PORT_NUM,plugin)
...
#define sms_sdio_plug_notify(plugin) rk29sdk_wifi_set_carddetect(plugin)
...
extern void sms_chip_plug(int plugin);
