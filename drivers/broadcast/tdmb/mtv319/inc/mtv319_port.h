...
/* Determine whether or not DMB MSC header generated by MTV319 is enabled. */
//#define RTV_DMB_MSC_HDR_ENABLED

/* Determine whether or not DAB MSC header generated by MTV319 is enabled. */
//#define RTV_DAB_MSC_HDR_ENABLED
...
############################################################################*/
	...
	*================================================================*/
	...
	static INLINE U8 RTV_REG_GET(U8 reg)
	{
		...
		if (g_bRtvPage != 0xF)
			bRegVal = tdmb_i2c_read((U8)RTV_CHIP_ADDR, (U8)(reg));
		else {
			tdmb_i2c_write(RTV_CHIP_ADDR, 0x02, (0x62|0x80));
			bRegVal = tdmb_i2c_read((U8)(0x62<<1), (U8)(reg));
		}
	...
	static INLINE void RTV_REG_SET(U8 reg, U8 val)
	{
		if (g_bRtvPage != 0xF)
			...
			tdmb_i2c_write(RTV_CHIP_ADDR, 0x02, (0x62|0x80));
			tdmb_i2c_write((0x62<<1), (U8)(reg), (U8)(val));
		}
	}
...
|| defined(RTV_IF_SPI)
	...
	#if !defined(RTV_DMB_MSC_HDR_ENABLED) && !defined(RTV_DAB_MSC_HDR_ENABLED)
		#error "Must define RTV_DMB_MSC_HDR_ENABLED definition"
	#endif
#endif

#if (RTV_MAX_NUM_USE_SUBCHANNEL == 0)
	#if defined(RTV_DMB_MSC_HDR_ENABLED) || defined(RTV_DAB_MSC_HDR_ENABLED)
		#error "Must NOT define"
	#endif
#endif
