...
static struct of_dev_auxdata msm8939_auxdata_lookup[] __initdata = {
	{}
};
 ...
 */
void __init msm8939_add_drivers(void)
{
	msm_smd_init();
	msm_rpm_driver_init();
	msm_spm_device_init();
...
{
	struct of_dev_auxdata *adata = msm8939_auxdata_lookup;
...
DT_MACHINE_START(MSM8939_DT, "Qualcomm MSM 8939 (Flattened Device Tree)")
