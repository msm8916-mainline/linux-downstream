...
static const struct snd_kcontrol_new dummy_switch[] = {
	SOC_DAPM_SINGLE("Switch",
		MSM8X16_WCD_A_ANALOG_MICB_1_EN, 7, 1, 0)
};
...
static const struct snd_soc_dapm_widget msm8x16_wcd_dapm_widgets[] = {
	SND_SOC_DAPM_OUTPUT("DUMMY_END"),
	SND_SOC_DAPM_MIXER("DUMMY", SND_SOC_NOPM, 0, 0,
        dummy_switch, ARRAY_SIZE(dummy_switch)),
...
#if defined(CONFIG_SND_SOC_ES705_ESCORE)
