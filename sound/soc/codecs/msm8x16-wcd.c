...
/*modify by TCT_CD(shitao.qiu@tcl.com),PR 864412 20150121 start*/	
/*[PR 864412]:Sometimes FM background play has no sound after incoming call*/
#if 0
...
#endif
/*modify by TCT_CD(shitao.qiu@tcl.com),PR 864412 20150121 end*/	
