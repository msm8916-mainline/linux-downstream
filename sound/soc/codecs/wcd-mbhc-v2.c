					 ...
					 enum wcd_mbhc_plug_type plug_type)
{
	...
	if (plug_type == MBHC_PLUG_TYPE_HEADPHONE) {
		...
		/*modify by TCT_CD(shitao.qiu@tcl.com),[bug]DUT will be speaker mode when insert HTC headset. 20141230 bugID:880549 start*/	
			//wcd_mbhc_report_plug(mbhc, 1, SND_JACK_LINEOUT);
			wcd_mbhc_report_plug(mbhc, 1, SND_JACK_HEADPHONE);
		/*modify by TCT_CD(shitao.qiu@tcl.com),[bug]DUT will be speaker mode when insert HTC headset. 20141230 bugID:880549 end*/		
