...
static const char *const ec_ref_rx[] = { "None", "SLIM_RX", "I2S_RX",
	"PRI_MI2S_TX", "SEC_MI2S_TX","TERT_MI2S_TX",
	"QUAT_MI2S_TX", "SEC_I2S_RX", "PROXY_RX"};
...
static const struct snd_kcontrol_new tx_voice_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_CS_VOICE, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
/* 2015.6.6 porting quat i2s path begin */
	SOC_SINGLE_EXT("QUAT_MI2S_TX_Voice", MSM_BACKEND_DAI_QUATERNARY_MI2S_TX,
	MSM_FRONTEND_DAI_CS_VOICE, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
/* 2015.6.6 porting quat i2s path end */
};
...
static const struct snd_kcontrol_new quat_mi2s_rx_port_mixer_controls[] = {
	...
	msm_routing_put_port_mixer),
	/* 2015.6.6 porting quat i2s path begin*/
	SOC_SINGLE_EXT("PRI_MI2S_RX", MSM_BACKEND_DAI_QUATERNARY_MI2S_RX,
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	/*2015-06-8 add qcom patch for i2s start*/
	{"QUAT_MI2S_RX Port Mixer", "PRI_MI2S_RX", "PRI_MI2S_RX"},
	/*2015-06-8 add qcom patch for i2s end*/
