...
#define EXFAT_CONFIG_PAGESIZE_ALIGNED_BLOCK	1
#define EXFAT_CONFIG_READAHEAD	1
#define EXFAT_CONFIG_BLKDEV_LOCK_BUFFER	0
#define EXFAT_CONFIG_FS_TYPE_CHECK		1


#define EXFAT_CONFIG_FIX_NAME_ENTRY_PADDING	1
#define EXFAT_CONFIG_FIX_FILE_NAME_TOO_LONG_ERROR_TYPE	1
