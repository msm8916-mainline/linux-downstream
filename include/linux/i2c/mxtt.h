...
#define MXT_DEV_NAME	"atmel_mxt_1664t"
#else
...
#if defined(CONFIG_MACH_GT5NOTE103G_EUR_OPEN) || defined(CONFIG_MACH_GT5NOTE10_EUR_OPEN) || defined(CONFIG_MACH_GT5NOTE10WIFI_EUR_OPEN)  \
	|| defined(CONFIG_MACH_GT5NOTE10_CHN_OPEN) || defined(CONFIG_MACH_GT5NOTE10_KOR_OPEN)
#define MXT_FIRMWARE_NAME_NEW_REVISION		"mxtt_gt5note10.fw"
#else
#define MXT_FIRMWARE_NAME_NEW_REVISION		"mxtt_gt510lte.fw"
#endif
 ...
 *  remove below boolean...*/
	...
	bool is_inputmethod;
#endif
    u16 ypos_of_zeroX[MXT_MAX_FINGER]; /* 0309 */
};
