...
struct touch_device_driver {
	...
	enum error_type (*fw_recovery) (struct i2c_client *client,
	...
	enum error_type (*reset) (struct i2c_client *client, int reset_ctrl);
};
...
struct lge_touch_data {
	...
	struct touch_fw_info		fw_recovery_info;
