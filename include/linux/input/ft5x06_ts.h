...
#define VENDOR_BOE              0x85  // BOE buy the panel from JD .Maybe.
#define VENDOR_BOE_LATER        0xda

#define VENDOR_DSJM             0x79
#define VENDOR_DSJM_LATER       0x53

#define FT_REG_FW_VENDOR_ID		0xA8
#define FT_REG_CHARGE_STATUS	0x8b
